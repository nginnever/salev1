...
//     })
//   })
//   it("updates the token minter", function() {
//     return token.setMintAgent(crowdsaleAddy, true, {from: accounts[0]}).then(function(tx) {
//       return token.mintAgents(crowdsaleAddy)
//     }).then(function(agent){
//       assert.isTrue(agent)
//     })
//   })
